...
% IWN: Standard Model
\newcommand{\Lg}[1]  {\mathcal{L}_\text{#1}}
\newcommand{\ff}[2]{#1_\text{#2}} % fermion field
\newcommand{\aff}[2]{\overline{#1}\vphantom{#1}_\text{#2}} % anti-fermion field
\newcommand{\U}[2][]{\text{U}(#2)\ifthenelse{\isempty{#1}}{}{_\text{#1}}}
\newcommand{\SU}[2][]{\text{SU}(#2)\ifthenelse{\isempty{#1}}{}{_\text{#1}}}
\newcommand{\GSM}    {{\ensuremath{\SU[C]{3}\times\SU[L]{2}\times\U[Y]{1}}}\xspace}
...
\newcommand{\hc}     {{\ensuremath{\text{h.c.}}}\xspace}

% IWN: common particles / final states
\newcommand{\tausub}[1]{{\ensuremath{\PGt\kern-0.5pt_{#1}}}\xspace}
\newcommand{\tauh}   {{\ensuremath{\PGt\kern-0.5pt_\text{h}}}\xspace}
\renewcommand{\tt}   {{\ensuremath{\PGt\PGt}\xspace}}
\newcommand{\m}      {{\ensuremath{\PGm}}\xspace}
...
\newcommand{\LQs}    {{\ensuremath{\mathrm{LQs}}}\xspace}
\newcommand{\LQb}    {{\ensuremath{\overline{\mathrm{LQ}}}}\xspace}
...
\newcommand{\ystar}  {{\ensuremath{y^{*}}}\xspace} %\star
\newcommand{\yboost} {{\ensuremath{y_\text{boost}}}\xspace}
\newcommand{\ST}     {{\ensuremath{S_\mathrm{T}}}\xspace}
\newcommand{\STMET}  {{\ensuremath{S_\mathrm{T}^\text{MET}}}\xspace}
...
\newcommand{\mtau}   {\ensuremath{m_{\tauh}}\xspace}
\newcommand{\mLQ}    {{\ensuremath{m_{\LQ}}}\xspace}
\newcommand{\Irel}   {\ensuremath{I_\text{rel}}}
\newcommand{\Njets}  {\ensuremath{N_\text{jets}^\PGm}\xspace}
