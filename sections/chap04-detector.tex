...
\input{tex/detector-fig-LHC.tex}
...
% FIGURE: luminosity
\input{tex/detector-fig-luminosity.tex}
...
% data
This thesis is based on an analysis of pp collision data recorded between 2016 and 2018.
...
% FIGURE: CMS detector
\input{tex/detector-fig-CMS.tex}

The Compact Muon Solenoid (CMS) detector is located near the French town of Cessy, and lies about 100 meters deep at one of the interaction points at the LHC (see \Fig{fig:CERN_complex}).
...
% FIGURE: Subdetectors
\input{tex/detector-fig-CMS_subdetectors.tex}
